...
def TCRB_Model_Integration(FULL_M, CNN_M, RESNET_M, FULL_Feature, CNN_Feature, RESNET_Feature):
    ...
    Y_pred_individual = np.stack((Y_PRED_FULL, Y_PRED_CNN, Y_PRED_RESNET), axis=-1)  # Save individual predictions
    ...
    return Y_pred_ALL, Y_pred_ALL_avg, Y_pred_individual    
...
def pred_A(user_dir):
    TCRA_FULL_M = './model/Article/FULL_A_ALL_onehot.h5'
    TCRA_CNN_M = './model/Article/CNN_A_ALL_onehot.h5'
    TCRA_RESNET_M = './model/Article/RESNET_A_ALL_pca15.h5'
