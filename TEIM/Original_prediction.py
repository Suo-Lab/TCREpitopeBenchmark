...
for i in name:
    for j in me:
        ...
        predict_binding(testfile_path,result_path,batch_size=128)     
...
for i in name:
    for j in me:
        ...
        result_path="./evaluate/repeat10/Prediction/all/unseen/"+i+j
        predict_binding(testfile_path,result_path,batch_size=128)     
...
for i in name:
    for j in me:
        ...
        result_path="./evaluate/repeat10/Prediction/all/seen/seven/"+i+j
        predict_binding(testfile_path,result_path,batch_size=128)      
